...
export default function Scene({ sentence, flavor }: SkyDiveProps) {
  ...
  console.log('ANGLE ', ANGLE) // 1.3089969389957472
  console.log('getXPosition ', -4 * Math.cos(ANGLE)) // -1.035276180410083
  console.log('getYPosition ', -4 * Math.sin(ANGLE)) // -3.8637033051562732

  const getXYPositions = (distance: number) => ({
    // x: getXPosition(distance),      // -1.035276180410083
    // y: getYPosition(-1 * distance), // 3.8637033051562732
    x: getXPosition(distance),      // -1.035276180410083
    y: getYPosition(-1 * distance), // 3.8637033051562732
  });
  ...
  useGSAP(() => {
    if (
      ...
      console.log('canRef.current ', canRef.current)
      return; 
    }
